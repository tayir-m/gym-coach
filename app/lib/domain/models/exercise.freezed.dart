...
mixin _$Exercise {
 ...
 String get name; int get sets; String get reps; int get restSeconds; String? get notes;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,sets,reps,restSeconds,notes);

@override
String toString() {
  return 'Exercise(name: $name, sets: $sets, reps: $reps, restSeconds: $restSeconds, notes: $notes)';
}
...
@useResult
$Res call({
 String name, int sets, String reps, int restSeconds, String? notes
});
...
/// Create a copy of Exercise
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? sets = null,Object? reps = null,Object? restSeconds = null,Object? notes = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  int sets,  String reps,  int restSeconds,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.name,_that.sets,_that.reps,_that.restSeconds,_that.notes);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  int sets,  String reps,  int restSeconds,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _Exercise():
return $default(_that.name,_that.sets,_that.reps,_that.restSeconds,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  int sets,  String reps,  int restSeconds,  String? notes)?  $default,) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.name,_that.sets,_that.reps,_that.restSeconds,_that.notes);case _:
  return null;
...
class _Exercise implements Exercise {
  const _Exercise({required this.name, required this.sets, required this.reps, this.restSeconds = 90, this.notes});
...
/// Create a copy of Exercise
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? sets = null,Object? reps = null,Object? restSeconds = null,Object? notes = freezed,}) {
